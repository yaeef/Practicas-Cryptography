...
<div class="container">
    ...
    <form method="post" action="index.php">
        ...
        <div id="contenedor-valor-extra">
            ...
            <input type="text" name="valor_extra" id="valor_extra" placeholder="Desplazamiendo del 0 al 255" pattern="^(?:[0-9]|[0-9][0-9]|1[0-9][0-9]|2[0-5][0-5])$">
        </div>
    ...
    if(isset($_POST['ejecutar']))
    {
        ...
        if ($flag === '-e') 
        {
            ...
            $comando = './ceasarBMP ' . $flag . ' ' . $path . ' ' . $valor_extra;
        } 
        else 
        {
            $comando = './ceasarBMP ' . $flag . ' ' . $path .' ' . '0';
        }
